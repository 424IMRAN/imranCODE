<%@page import="paytm.paytm_java.PaytmConstants"%>
...
parameters.put("MOBILE_NO","9505263203");
parameters.put("EMAIL","admin@swish.com");
parameters.put("CALLBACK_URL", "http://www.gorideswish.com/pgResponse.jsp");
